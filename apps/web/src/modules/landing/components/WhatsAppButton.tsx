...
export function WhatsAppButton(): React.JSX.Element {
  ...
  return (
    <motion.div
      ...
      className="fixed bottom-6 right-5 z-50 sm:bottom-8 sm:right-6"
    >
      <a
        href={waUrl}
        target="_blank"
        ...
        className={[
          ...
          'focus-visible:ring-2 focus-visible:ring-[#25D366] focus-visible:ring-offset-2 focus-visible:ring-offset-background',
          shouldReduce ? '' : 'animate-pulse-ring',
        ]
          .filter(Boolean)
          .join(' ')}
      >
